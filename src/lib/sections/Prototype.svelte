	...
	<div class="bg-white w-full h-screen relative">
		<div class="absolute w-1/3 top-40 right-20">
			...
			<p class="text-white mt-10">
				We've built a small prototype to detect marine debris on the coast of Durban located in
				South Africa where a flood event on the 18th of April in 2019 washed out a lot of plastic.
				We are using data from the sentinel-2 satellite taken six days post-event. Our prototype
			...
			<button
				...
				on:click={() => goto('/map')}
				on:keypress={() => goto('/map')}><h1>VIEW PROTORYPE</h1></button
			>
		</div>
		<img
