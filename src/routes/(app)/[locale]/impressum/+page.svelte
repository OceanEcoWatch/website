<script lang="ts">
	function openEMail() {
		window.location.href = 'mailto:contact@oceanecowatch.org';
	}
</script>

<div class="p-5">
	<h1 class="font-bold text-5xl mb-10">Impressum & Datenschutz</h1>
	<div class="mb-5">
		<h3 class="font-bold text-2xl">Angaben gemäß § 5 TMG</h3>
		<p>Emely Henninger<br /> Lohmühlenstraße 65 <br /> 12435 Berlin <br /> Germany</p>
	</div>

	<div class="mb-5">
		<h3 class="font-bold text-2xl">Kontakt</h3>
		<p>
			Telefon: 004915770385290<br /> Mail:
			<span class="anchor" on:click={openEMail} on:keypress={openEMail} role="link" tabindex="0"
				>contact@oceanecowatch.de</span
			>
		</p>
	</div>

	<div class="mb-5">
		<h3 class="font-bold text-2xl">Haftungsausschluss</h3>
		<h3 class="text-2xl">Haftung für Inhalte</h3>
		<p>
		...
		<h3 class="text-2xl">Haftungsbeschränkung für externe Links</h3>
		<p>
			Haftung für Links Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte
	...
	<div class="mb-5">
		<h3 class="font-bold text-2xl">Datenschutz</h3>
		<p>
			...
			weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per
			...
			angeforderter Werbung und Informationsmaterialien wird hiermit ausdrücklich widersprochen. Die
